          ...
          return (
            <li key={p.id} className={`rounded-2xl border-2 ${s.border} overflow-hidden`}>
              <button
                ...
                className="flex items-center gap-3 w-full min-w-0 text-left px-4 py-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal/40 rounded-2xl"
              >
                ...
                <div id={`details-${p.id}`} className="px-4 pb-4 pt-1 font-body text-sm">
                  ...
                  <div className="mt-3 flex gap-2">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-teal text-teal hover:bg-teal/10 transition-colors font-display font-bold py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal/40"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-rose-200 text-rose-600 hover:bg-rose-50 transition-colors font-display font-bold py-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-rose-300"
                    >
